...
class BrowseApp {
    ...
    goToPage(page) { this.state.currentPage = page; this._loadCharacters(); }
    doSearch() { this.state.searchQuery = document.getElementById('searchInput').value; this.state.currentPage = 1; this._loadCharacters(); }
    clearSearch() { this.state.searchQuery = ''; document.getElementById('searchInput').value = ''; this.state.currentPage = 1; this._loadCharacters(); }
